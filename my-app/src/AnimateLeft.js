...
class Items extends Component {
	...
	render() {
		...
		return (
			<div 
			  className="animate_content_item"
            	...
            	<div 
            	 ...
            	 >
             	  <a href="#" className="animate_content_images_a" >
            		...
            		<div className={this.props.onmouse?"PlayAndDanmarku-hide":"PlayAndDanmarku"}>
        			  	<img src={require("./picture/danmaku.png")}></img>
                		<img src={require("./picture/playnumber.png")}></img>
             		</div>
       			  </a>
            	</div>
            	<div className={this.props.onmouse?"animate_content_item_show":"animate_content_item_hide"} >
            	  <a href="#" >{e.time}</a>
  				  <a href="#" title="稍后再看">
             		<img 
